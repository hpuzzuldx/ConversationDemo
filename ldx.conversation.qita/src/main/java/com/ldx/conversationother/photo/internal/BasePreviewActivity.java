...
import com.ldx.conversationother.photo.internal.ui.widget.CheckView;
...
import com.ldx.conversationother.photo.internal.utils.PhotoMetadataUtils;
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected ImageView mButtonBackImg;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.photo_activity_media_preview);
        ...
        mButtonBackImg = (ImageView) findViewById(R.id.childpreview_toolbar_navibackimg);
        mButtonApply = (TextView) findViewById(R.id.button_apply);
        mSize = (TextView) findViewById(R.id.size);
        mButtonBack.setOnClickListener(this);
        mButtonBackImg.setOnClickListener(this);
    ...
    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.button_back || v.getId() == R.id.childpreview_toolbar_navibackimg) {
            onBackPressed();
