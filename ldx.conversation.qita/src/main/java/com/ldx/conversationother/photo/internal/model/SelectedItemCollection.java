package com.ldx.conversationother.photo.internal.model;
        ...
        if (maxSelectableReached()) {
            ...
            try {
                cause = mContext.getResources().getString(
                        R.string.photo_error_over_count,
                        maxSelectable
                );
            ...
            return new IncapableCause(mContext.getString(R.string.photo_error_type_conflict));
        }
