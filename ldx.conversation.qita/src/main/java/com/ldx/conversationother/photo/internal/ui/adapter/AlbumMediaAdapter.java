package com.ldx.conversationother.photo.internal.ui.adapter;
...
import com.ldx.conversationother.photo.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.photo_media_grid_item, parent, false);
    ...
    private int getImageResize(Context context) {
        if (mImageResize == 0) {
            ...
            int availableWidth = screenWidth - context.getResources().getDimensionPixelSize(
                    R.dimen.photo_media_grid_spacing) * (spanCount - 1);
