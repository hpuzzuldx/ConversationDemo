...
public class XICameraManager {
    private static final String TAG = "XICameraManager";
    ...
    public static XICameraManager getInstance() {
        return SingletonHolder.instance;
    }

    private static class SingletonHolder {
        private static XICameraManager instance = new XICameraManager();
    }

    private XICameraManager() {
    ...
    private void openImmediate() {
        ...
        try {
            ...
            XICameraUtils.setPreviewParams(mSurfaceSize, parameters);
            ...
            XIConLogUtil.e(TAG, "open camera failed", th);
        }
    }
    ...
    public void setFocus(final float x, final float y, final Callback<Boolean> callback) {
        ...
        mThreadHandler.post(new SafeRunnable() {
            ...
            public void runSafely() {
                ...
                Camera.Parameters parameters = mCamera.getParameters();
                XICameraUtils.setFocusArea(mSurfaceSize, parameters, x, y);
                mCamera.setParameters(parameters);
        ...
        mThreadHandler.post(new SafeRunnable() {
            ...
            public void runSafely() {
                ...
                if (parameters.isZoomSupported()) {
                    boolean valid = XICameraUtils.setZoom(mSurfaceSize, parameters, span);
                    if (valid) {
                        mCamera.setParameters(parameters);
                    }
                }
                ...
                mCamera.takePicture(null, null, new Camera.PictureCallback() {
                    ...
                    public void onPictureTaken(byte[] data, Camera camera) {
                        ...
                        if (data != null && data.length > 0) {
                            ...
                            XIConLogUtil.d("takePicture:"+bitmap.getWidth()+"    "+bitmap.getHeight());
                        ...
                        mUiHandler.post(new Runnable() {
                            ...
                            public void run() {
                                if (callback != null) {
                                    XIConLogUtil.d("takePicture:result "+result.getWidth()+"    "+result.getHeight());
    ...
    private void setState(State state) {
        XIConLogUtil.d(TAG, "change state from " + mState + " to " + state);
        mState = state;
    }
    ...
    private static abstract class SafeRunnable implements Runnable {
        ...
        public final void run() {
            try {
                ...
                XIConLogUtil.e(TAG, "camera error", th);
            }
        }
