...
public class XICameraUtils {
    ...
    public static void setPreviewParams(Point surfaceSize, Camera.Parameters parameters) {
        ...
        if (previewSize != null) {
            ...
            XIConLogUtil.d(TAG, "previewSize: width: " + previewSize.width + ", height: " + previewSize.height);
        }
        ...
        if (pictureSize != null) {
            ...
            XIConLogUtil.d(TAG, "pictureSize: width: " + pictureSize.width + ", height: " + pictureSize.height);
        }
