 ...
 */
public class XIStatusBarUtil {

    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    private static  int FAKE_STATUS_BAR_VIEW_ID = R.id.xiconversation_statusbarutil_fake_status_bar_view;
    private static  int FAKE_TRANSLUCENT_VIEW_ID = R.id.xiconversation_statusbarutil_translucent_view;
    private static int TAG_KEY_HAVE_SET_OFFSET = -123;
    ...
    public static boolean canChangeTitleColor() {
        boolean canChange = false;
        boolean isMIUI = MIUIUtils.isMIUI();
        boolean isFlyme = FlymeUtils.isFlyme();
        boolean isM = Build.VERSION.SDK_INT >= Build.VERSION_CODES.M;
        canChange = isMIUI || isFlyme || isM;
        return canChange;
    }
}
