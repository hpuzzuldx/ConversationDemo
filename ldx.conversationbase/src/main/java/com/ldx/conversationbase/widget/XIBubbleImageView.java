...
public class XIBubbleImageView extends android.support.v7.widget.AppCompatImageView {
	...
	public XIBubbleImageView(Context context) {
		super(context);
		this.context = context;
	}

	public XIBubbleImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	}

	public XIBubbleImageView(Context context, AttributeSet attrs, int defStyle) {
