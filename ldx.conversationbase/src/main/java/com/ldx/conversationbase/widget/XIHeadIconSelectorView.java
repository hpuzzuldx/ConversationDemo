...
public class XIHeadIconSelectorView extends RelativeLayout implements
    ...
    public XIHeadIconSelectorView(Context context) {
        super(context);
        init();
    }
    ...
    private void findView() {
        ...
        baseView = LayoutInflater.from(getContext()).inflate(
                R.layout.xiconversation_view_headicon, this);
        mainRl = (RelativeLayout) baseView.findViewById(R.id.xiconversation_head_icon_main_rl);
        bottomLl = (LinearLayout) baseView.findViewById(R.id.xiconversation_head_icon_main_ll);
        cameraLl = (LinearLayout) baseView
                .findViewById(R.id.xiconversation_head_icon_camera_ll);
        galleryLl = (LinearLayout) baseView
                .findViewById(R.id.xiconversation_head_icon_gallery_ll);
        cancelLl = (LinearLayout) baseView
                .findViewById(R.id.xiconversation_head_icon_cancel_ll);
    }
