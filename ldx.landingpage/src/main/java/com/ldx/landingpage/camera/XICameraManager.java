...
public class XICameraManager {
    ...
    private void openImmediate() {
        ...
        try {
            ...
            XILogUtil.e(TAG, "open camera failed", th);
        }
    }
                ...
                mCamera.takePicture(null, null, new Camera.PictureCallback() {
                    ...
                    public void onPictureTaken(byte[] data, Camera camera) {
                        ...
                        if (data != null && data.length > 0) {
                            ...
                            XILogUtil.d("takePicture:"+bitmap.getWidth()+"    "+bitmap.getHeight());
                        ...
                        mUiHandler.post(new Runnable() {
                            ...
                            public void run() {
                                if (callback != null) {
                                    XILogUtil.d("takePicture:result "+result.getWidth()+"    "+result.getHeight());
    ...
    private void setState(State state) {
        XILogUtil.d(TAG, "change state from " + mState + " to " + state);
        mState = state;
    }
    ...
    private static abstract class SafeRunnable implements Runnable {
        ...
        public final void run() {
            try {
                ...
                XILogUtil.e(TAG, "camera error", th);
            }
        }
