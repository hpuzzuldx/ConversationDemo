...
public class XICameraView extends FrameLayout implements SurfaceHolder.Callback,
    ...
    private void init() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.xilandingpage_camera_layout, this, true);

        mSurfaceView = (SurfaceView) findViewById(R.id.xilandingpage_camera_surface);
        mFocusView = findViewById(R.id.xiconversation_camera_focus);
        mSwitchWrapper = findViewById(R.id.xilandingpage_camera_switch_wrapper);
        mSwitchView = findViewById(R.id.xilandingpage_camera_switch);
        mPictureView = (ImageView) findViewById(R.id.xilandingpage_camera_picture_preview);
        mCaptureLayout = (XICaptureLayout) findViewById(R.id.xilandingpage_camera_capture_layout);
