...
public class XICaptureLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void init() {
        setClickable(true);
        LayoutInflater.from(getContext()).inflate(R.layout.xilandingpage_camera_capture_layout, this, true);
        captureRetryLayout = findViewById(R.id.xilandingpage_camera_capture_retry_layout);
        btnCapture = (ImageView) findViewById(R.id.xilandingpage_camera_capture);
        btnRetry = (ImageView) findViewById(R.id.xilandingpage_camera_retry);
        btnClose = (ImageView) findViewById(R.id.xilandingpage_camera_close);
    ...
    private void expand() {
        btnCapture.setImageResource(R.drawable.xilandingpage_ic_camera_done);
