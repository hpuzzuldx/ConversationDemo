...
public class XIStatusBarUtil {
    ...
    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
      private static  int FAKE_STATUS_BAR_VIEW_ID = R.id.xilandingpage_statusbarutil_fake_status_bar_view;
      private static  int FAKE_TRANSLUCENT_VIEW_ID = R.id.xilandingpage_statusbarutil_translucent_view;
